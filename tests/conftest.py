...
def mock_settings():
    ...
    return {
        "profile": {"usage": "dev"},
        "input": {"data_directory": "data/input", "file_pattern": "*.jsonl"},
        "storage": {"history_directory": "data/history", "max_history_days": 30},
        "notifications": {
            "slack": {"enabled": True, "webhook_url": "https://hooks.slack.com/test"}
        },
        "output": {"default_mode": "normal", "max_items_per_notification": 10},
        "logging": {"level": "INFO", "file": "log/okina.log"},
    }
